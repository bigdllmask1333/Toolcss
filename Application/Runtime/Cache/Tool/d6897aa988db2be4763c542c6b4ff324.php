	...
	<div class="left_kuang">
		<div class="left_main">
			<div class="min-title">
			   ...
			   <!-- /工具开始 -->
			<!-- /工具开始 -->
		    <h3>将列表内容放入文本框内，<strong>每行一条</strong>，点击去重按钮，即可得到无重复数据的列表：</h3>
		        
			<textarea id="list" class="toolarea form-control"   rows="8">懒人图库
			www.cssnb.com
			www.baidu.com
			www.cssnb.com
			工具界库
			...
			zheye.cc
			www.baidu.com
			www.sssssssssssss.com
			zheye.cc
			懒工具界
			www.cssnb.com</textarea>
			<input type="button" onclick="process()" value="去重处理" class="bt-green btn btn-success">
		</div>
	</div>
