...
<!-- 		            <li role="separator" class="divider"></li>
	...
	<div class="left_kuang">
		<div class="left_main">
			...
			<!-- /工具开始 -->
		    <h3>请输入欲加密的字符串：</h3>
		    <textarea id="ipt" class="toolarea form-control"   rows="8" style="margin-top:40px;margin-bottom: 20px;">大家好</textarea>
		    <input type="button" class="bt-green btn btn-primary" onclick="jQuery(&#39;#ipt&#39;).val(escape(jQuery(&#39;#ipt&#39;).val()));" value="Escape加密">
		    <input type="button" class="bt-blue btn btn-danger" onclick="jQuery(&#39;#ipt&#39;).val(unescape(jQuery(&#39;#ipt&#39;).val()));" value="UnEscape解密">

		    <p><br />小贴士：可多次加密和解密。 Escape采用ISO Latin字符集对指定的字符串进行编码。所有的空格符、标点符号、特殊字符以及其他非ASCII字符都将被转化成%xx格式的字符编码(xx等于该字符在字符集表里面的编码的16进制数字)。</p>
