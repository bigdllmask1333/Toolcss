...
class Fanyi{
	...
	**************************************************************************/
	...
	// define("APP_ID",         "20170710000063944"); //替换为您的APPID
	// define("SEC_KEY",        "w7F3cEhHlLK85fuImqul");//替换为您的密钥
	// $APP_ID='20170710000063944';
	// $SEC_KEY='w7F3cEhHlLK85fuImqul';
	...
	function translate($query, $from, $to)
	{
		$args = array(
			'q' => $query,
			'appid' => '20170710000063944',
			'salt' => rand(10000,99999),
			'from' => $from,
			'to' => $to,

		);
		$args['sign'] =$this->buildSign($query, '20170710000063944', $args['salt'], 'w7F3cEhHlLK85fuImqul');
